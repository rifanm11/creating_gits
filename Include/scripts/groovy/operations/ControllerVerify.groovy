...
class ControllerVerify {
	...
	def verifybylavel(value) {
		WebUI.waitForElementPresent(findTestObject('Object Repository/GIT/byarialabel', ['PARAM' : value]), 10, FailureHandling.CONTINUE_ON_FAILURE)
